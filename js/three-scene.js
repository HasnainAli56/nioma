...
//// 1. HERO 3D SCENE: CINEMATIC DATA-NETWORK PLANET VIDEO 216034.MP4
function build3DScene0Hero(originX) {
    // The previous 3D globe, orbital torus rings, satellites, and data callout badges
    // are replaced by the high-definition video 216034.mp4 in the DOM.
    // Three.js continues rendering the ambient cosmic particle field and subsequent 3D scenes.
    heroGroup = new THREE.Group();
    heroGroup.position.set(originX + 3.2, 0, 0);
